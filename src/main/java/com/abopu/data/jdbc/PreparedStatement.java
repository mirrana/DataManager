 ...
 */
public class PreparedStatement<T> extends Statement<T> {
	...
	public ResultSet getResultSet() throws SQLException {
		return new com.abopu.data.jdbc.ResultSet<>(getStatement().getResultSet());
	}
	...
	private PreparedStatement getStatement() { return (PreparedStatement) super._statement; }
