 ...
 */
public class ResultSet<T> implements java.sql.ResultSet {
	...
	public Long getLong(ColumnDefinition<T> column) throws SQLException {
		long value = getLong(column.name());
		return wasNull() ? null : value;
	}

	public Integer getInt(ColumnDefinition<T> column) throws SQLException {
		int value = getInt(column.name());
		return wasNull() ? null : value;
	}

	public String getString(ColumnDefinition<T> column) throws SQLException {
		return getString(column.name());
	}
	
	public byte[] getBytes(ColumnDefinition<T> column) throws SQLException {
		return getBytes(column.name());
	}
	
	public Timestamp getTimestamp(ColumnDefinition<T> column) throws SQLException {
		return getTimestamp(column.name());
	}
	...
	/***************************************************************************
	 *
	 * Implementation: java.sql.ResultSet
	 *
	 **************************************************************************/
